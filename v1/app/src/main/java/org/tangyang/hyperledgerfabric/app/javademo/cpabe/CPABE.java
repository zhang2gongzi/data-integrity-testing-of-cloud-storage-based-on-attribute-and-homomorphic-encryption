...
public class CPABE {
    public static void setup(String pairingParametersFileName, String pkFileName, String mskFileName,int bitSize,int securityParameter) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(pairingParametersFileName))) {
    ...
    public static void keygenTest(String[] userAttList, String pkFileName, String mskFileName, String skFileName, String uid) throws NoSuchAlgorithmException {
        Properties pkProp = loadPropFromFile(pkFileName);
        Pairing bp = PairingFactory.getPairing(pkProp.getProperty("ppFile"));
    ...
    public static void keygenTest1(String[] userAttList, String pkFileName, String mskFileName, String skFileName, String uid) throws NoSuchAlgorithmException {
        Properties pkProp = loadPropFromFile(pkFileName);
        Pairing bp = PairingFactory.getPairing(pkProp.getProperty("ppFile"));
...
//        进行共享，使得每个叶子节点获得相应的秘密分片
    ...
    public static byte[] kemDecryptByte(String ctFileName, String skFileName) throws GeneralSecurityException, IOException {
