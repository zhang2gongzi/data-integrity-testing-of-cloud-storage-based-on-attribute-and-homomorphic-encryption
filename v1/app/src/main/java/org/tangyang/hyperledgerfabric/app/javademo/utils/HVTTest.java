...
public class HVTTest {
    public static void main(String[] args) throws NoSuchAlgorithmException, IOException {
        ...
        String dataPath = "C:\\Users\\唐杨\\Desktop\\实验\\完整性验证实验\\data\\shuju";
        ...
        List<BigInteger> hvts = GenerateHVT.generateTagByZr(gn[0],gn[1],dataPath,tagsPath,1000,bp);
        BigInteger[] ranP = GenerateHVT.randP(1000);
        ...
        BigInteger proof = GenerateHVT.generateProofFromZr(blockPath, chal, n, 1000,ranP,bp);
